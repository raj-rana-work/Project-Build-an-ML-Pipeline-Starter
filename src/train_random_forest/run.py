...
def get_inference_pipeline(rf_config, max_tfidf_features):
    ...
    preprocessor = ColumnTransformer(
        transformers=[
            ...
            ("transform_name", name_tfidf, ["neighbourhood_group"])
        ],
        remainder="drop",  # This drops the columns that we do not transform
    )

    processed_features = ordinal_categorical + non_ordinal_categorical + zero_imputed + ["last_review", "neighbourhood_group"]
